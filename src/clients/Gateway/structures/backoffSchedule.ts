 ...
 * from a 1 s base, capped at 60 s, with ±20% jitter — the D-8 owner-ratified values,
 * asserted here as arithmetic with no timer, real or fake, involved. n = 0 is 0 (the
 * failure counter's own reading: no failure yet, or reset by READY/RESUMED).
 * @internal
 */
